...
public class Automaton {
    ...
    public Automaton(String lastname, String firstname, String password, String email, String rights) {
    ...
    public Automaton(String lastname, String firstname, String password, String email) {
        this.lastname  = lastname;
        this.firstname = firstname;
        this.password  = password;
        this.email     = email;
